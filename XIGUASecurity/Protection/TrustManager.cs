...
namespace XIGUASecurity.Protection
{
    ...
    {
        private static readonly string TrustDataFile = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "XIGUASecurity", "trust_data.json");
