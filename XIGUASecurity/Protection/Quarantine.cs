...
namespace XIGUASecurity.Protection
{
    ...
    {
        private static readonly string QuarantineFolder = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "XIGUASecurity", "Quarantine");
        private static readonly string QuarantineDataFile = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "XIGUASecurity", "quarantine_data.json");
